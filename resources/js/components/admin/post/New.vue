              ...
              <form role="form" enctype="multipart/form-data" @submit.prevent="addnewPost()">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="postId" placeholder="Title"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="author" placeholder="Author Name"
                                        v-model="form.author" name="author" value="Softopark"
                                        :class="{ 'is-invalid': form.errors.has('title') }">
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"
                                                id="basic-addon3">https://blogs.softopark.com/</span>
                                        </div>
                                        <input type="text" class="form-control" id="slug" placeholder="URL"
                                            v-model='getslug' v-bind="form.slug"  name="slug"
                            ...
                            <div class="card-footer">
                                ...
                                <button type="submit" class="btn btn-success" value="draft">Save as Draft</button>
                            </div>
                        </form>
            </div>
